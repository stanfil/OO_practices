...
describe('practice-2', () => {
    ...
    it('should print what teacher knows', () => {
        let klass1 = new Class(2);
        let klass2 = new Class(3);
        let teacher = new Teacher(1,'Tom',21,[klass1,klass2]);
        let teacher2 = new Teacher(2,'Jack',22,[klass1]);
        let jerry = new Student(3,"Jerry",21,klass1);

        const result1 = `I am Tom. I know Jerry has joined Class 2.`;
        const result = `I am Jack. I know Jerry has joined Class 2.`;
        const result2 = `I am Tom. I know Jerry become Leader of Class 2.`;
        const result3 = `I am Jack. I know Jerry become Leader of Class 2.`

        spyOn(console,'log');

        klass1.appendMember(jerry);

        expect(console.log).toHaveBeenCalledWith(result1);
        expect(console.log).toHaveBeenCalledWith(result);

        klass1.assignLeader(jerry);
        expect(console.log).toHaveBeenCalledWith(result2);
        expect(console.log).toHaveBeenCalledWith(result3);
